#ifndef SnakeGame_ACHIEVEMENTS_FIVE_HUNDRED_SCORE_HPP
#define SnakeGame_ACHIEVEMENTS_FIVE_HUNDRED_SCORE_HPP
#include <vector>

#include "../Achievement.hpp"
class FiveHundredScore {
 public:
  FiveHundredScore();
  ~FiveHundredScore();
...
#endif  //! SnakeGame_ACHIEVEMENTS_FIVE_HUNDRED_SCORE_HPP